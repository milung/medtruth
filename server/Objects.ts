...
export class JSONCreator {
    getUploadJSON() {
        ...
        this.setSeries(seriesUno, "gsdf51hsf651.654gsdf54.g4ds",
            "Head scan or something.",
            "Plávka Adrián",
            new Date(1234567890123).getTime(),
            "image04");

        this.setSeries(seriesDue, "gsfd54.fg4df5hf4.5g4d",
            "Don't know what this thing is LOL",
            "Durneková Martina",
            new Date(1235567890123).getTime(),
            "image03");

        this.setSeries(seriesTre, "d54gdfs5g4d8.8f4h6df4",
            "Scan of some part of the body.",
            "Hlavatý Tomas",
            new Date(1243567890123).getTime(),
            "image01");
        ...
        this.setSeries(seriesNeviem, "w15fsd51.51sdfa.54",
            "This is a scan of another scan. SCANCEPTION !",
            "Pištek Marek",
            new Date(1283467890123).getTime(),
            "image06");
    ...
    setSeries(series: SeriesJSON, seriesID: string, seriesDescription: string,
        patientName: string, birthday: number, thumbnail: string) {
