...
*/
exports.routerImages.options('/', function (req, res) {
    return res.json({
...
*/
exports.routerImages.get('/', function (req, res) {
...
*/
exports.routerImages.get('/latest', function (req, res) {
    res.sendStatus(constants_1.StatusCode.NotImplemented);
});
/*
...
*/
exports.routerImages.get('/:id', function (req, res) { return __awaiter(_this, void 0, void 0, function () {
    var id, url, e_1;
