        ...
        return (
            <div style={{ marginLeft: 10, marginBottom: 10, marginRight: 10 }}>
                ...
                <Grid item={true} xs={12} sm={12} md={12} style={imageStyle.seriesStyle} >
                    <Typography type="body1">Name: <b>{this.props.patients[0] !== undefined ? this.props.patients[0].patientName : ''} </b></Typography>
                    ...
                    <Typography type="body1">Series description: <b>{this.props.series[0] !== undefined ? this.props.series[0].seriesDescription : ''}</b></Typography>
                </Grid>
