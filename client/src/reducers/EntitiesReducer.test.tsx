import {
    ...
    ImagesAnnotationAddedAction, ImagesAnnotationsDownloadedAction, Annotation
...
describe('EntitiesReducer', () => {
    ...
    it('should handle ImagesAnnotationsDownloadedAction', () => {
        ...
        let imagesAnnotations: Map<string, Annotation[]> = new Map(
            [
